...
data_str="D:\matlab工具箱\代码\已发表论文（处理完成）\Github代码\dataset.xlsx";  %读取数据的路径 	
...
[Mdl,fitness,Convergence_curve] = optimize_fitrkernel(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti);   	
